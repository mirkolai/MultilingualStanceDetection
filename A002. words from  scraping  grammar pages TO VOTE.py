...
def savewords(language, page):
    ...
    if language!="ca":
        contents = soup.findAll('div',{'class':'conj-result'})
    else:
...
pages={
    "en":"http://it.bab.la/coniugazione/inglese/vote",
    "it":"http://it.bab.la/coniugazione/italiano/votare",
    "fr":"http://it.bab.la/coniugazione/francese/voter",
    "es":"http://it.bab.la/coniugazione/spagnolo/votar",
    "ca":"http://www.verbs.cat/ca/conjugacio/330-votar.html",
